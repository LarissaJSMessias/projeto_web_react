...
// colocar o toggledtreeview no codigo do render
          ...
          <ul class="app-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li>
                  <a class="treeview-item" href="/cliente/listar">
                    <i class="icon fa fa-circle-o"></i>Cliente
                  </a>
                </li>
                <li>
                  <a class="treeview-item" href="/voo/listar'">
                    <i class="icon fa fa-circle-o"></i>Voo
                  </a>
                </li>
                <li>
                  <a class="treeview-item" href="/reserva/listar">
                    <i class="icon fa fa-circle-o"></i>Reserva
                  </a>
                </li>
                <li>
